    ...
    <div className="p-4 min-h-[calc(100vh-120px)] bg-[rgba(0,0,0,0.04)] rounded-[10px] flex flex-col">
      ...
      <div className="mb-4 flex justify-between items-center w-full md:w-[58vw] lg:w-[60vw] mx-auto">
        <input
          ...
          className="w-full h-[40px] p-4 text-left rounded-[30px] focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
      </div>
      {loading ? (
        ...
        <div className="md:w-[58vw] lg:w-[60vw] mx-auto bg-white rounded-lg shadow overflow-hidden">
